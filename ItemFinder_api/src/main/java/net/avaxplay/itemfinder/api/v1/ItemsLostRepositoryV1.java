...
public class ItemsLostRepositoryV1 {
    ...
    public List<Item> searchAndSort(String searchPhrase, String orderByColumn, boolean descending, boolean filtered) {
        ...
        return jdbcClient.sql("SELECT * FROM " + (filtered ? "FoundItemsFiltered" : "LostItems") + ((searchPhrase == null || searchPhrase.isBlank()) ? " " : " WHERE ItemName ILIKE :Search ") + "ORDER BY " + column + " " + (descending ? "DESC" : "ASC"))
